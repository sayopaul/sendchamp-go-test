...
type Config struct {
	...
	SocketConnectionHost string `mapstructure:"SOCKET_CONNECTION_HOST"`
	SocketConnectionPort string `mapstructure:"SOCKET_CONNECTION_PORT"`
	SocketConnectionType string `mapstructure:"SOCKET_CONNECTION_TYPE"`
}
