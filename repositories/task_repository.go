...
func (tr TaskRepository) UpdateTask(taskCondition models.Task, task models.Task) (models.Task, error) {
	return task, tr.db.DB.Model(models.Task{}).Where(&taskCondition).Updates(&task).Error
}
